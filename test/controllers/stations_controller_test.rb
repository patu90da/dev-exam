...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { duration: @station.duration, name: @station.name, route_name: @station.route_name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { duration: @station.duration, name: @station.name, route_name: @station.route_name } }
